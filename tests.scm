...
******** Tests for Problem 7 *********
(eval(eval(cons 'car '(' ((+ (*) (*) (*)) 2)))))
; expect 3

(car (cons(+ 5 (*) (*)) (cons (eval(eval(cons 'car '(' ((+ (*) (*) (*)) 2))))) nil)))
; expect 7

(cdr (cons(+ 5 (*) (*)) (cons(eval(eval(cons 'car '(' ((+ (*) (*) (*)) 2))))) nil)))
; expect (3)

******** Tests for Problem 8 *********
(begin (+ 5 (*) (*))(eval(eval(cons 'car '(' ((+ (*) (*) (*)) 2))))))
; expect 3

******** Tests for Problem 9 *********
((lambda (x) (+ x 1) (- 4 x) (* x x)) 4)
; expect 16

(((lambda (g) (lambda (f) (+ f 8 g))) 2)5)
; expect 15
...
a
; expect (lambda () (define (j x y) (+ x y)) (j 2 3))
...
(double-up(+ (a 2 2) ((t 2 2) 7 7)))
; expect 36

******** Tests for Problem 13 *********
(or (*) (/ 1 (+)))
; expect 1
(or (and (or 3 (/1 (+))) (/ 1 (+))) True)
; expect Error

(eval(or (and (or 3 (/1 (+))) (define x 3)) False))
; expect 3
...
(define y 200)
; expect y
(let ((x (double-up(+ (a 2 2) ((t 2 2) 7 7)))) (y 2)) (let ((x 1) (y 0)) (+ x y)))
; expect 1
(list x y)
; expect (100 200)
...
(define n (mu (x y) (* (*) q x y z)))
((((lambda (g) (lambda (z) (lambda (q)(n 2 6))))4)2)5)
; expect 120
...
************ Other Random Tests ********
(eval(list 'quotient 0 (+ (* (*) 10) 20)))
; expect 0

(eval(list 'quotient (+(* (*) 10) 20) 0)))
; expect Error
;;; **********************************
